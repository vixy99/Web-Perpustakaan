...
if(isset($_GET['id'])) {
    ...
    $tgl_harus_kembali = date('Y-m-d', strtotime($data['tgl_harus_kembali'] . ' +5 days'));
?>
<div class="container">
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col">
                            <form action="simpan_peminjaman.php" method="POST" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="tgl_pinjam" class="form-control" id="tgl_pinjam" value="<?= isset($data['tgl_harus_kembali']) ? $data['tgl_harus_kembali'] : ''; ?>">
                                </div>

                                <div class="form-group">
                                <label for="tgl_harus_kembali">Tanggal Harus Kembali</label>
                                <input type="date" class="form-control" id="tgl_harus_kembali" disabled value="<?= $tgl_harus_kembali; ?>">
                                <input type="hidden" name="tgl_harus_kembali" value="<?= $tgl_harus_kembali; ?>">
                                </div>
                                ...
                                <input type="text" class="form-control" id="status_pinjam" placeholder="Masukkan Nama Produk" disabled value="<?= $data['status_pinjam']; ?>">
                                <input type="hidden" name="status_pinjam" class="form-control" id="status_pinjam" placeholder="Masukkan Nama Produk"  value="<?= $data['status_pinjam']; ?>">
                                </div>
